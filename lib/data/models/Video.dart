...
class ShortcodeMedia {
  ...
  factory ShortcodeMedia.fromJson(Map<String, dynamic> json) => ShortcodeMedia(
        ...
        edgeMediaPreviewComment: EdgeMediaPreviewComment.fromJson(
        ...
        edgeMediaPreviewLike:
            EdgeMediaPreviewLike.fromJson(json["edge_media_preview_like"]),
...
class EdgeMediaPreviewComment {
  ...
  factory EdgeMediaPreviewComment.fromJson(Map<String, dynamic> json) =>
      EdgeMediaPreviewComment(
        count: json["count"],
...
class PurpleNode {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "edge_threaded_comments":
            edgeThreadedComments == null ? null : edgeThreadedComments.toJson(),
      };
}
...
class EdgeMediaPreviewLike {
  ...
  factory EdgeMediaPreviewLike.fromJson(Map<String, dynamic> json) =>
      EdgeMediaPreviewLike(
        count: json["count"],
        edges: List<EdgeMediaPreviewLikeEdge>.from(
            json["edges"].map((x) => EdgeMediaPreviewLikeEdge.fromJson(x))),
      );
...
class EdgeMediaPreviewLikeEdge {
  ...
  factory EdgeMediaPreviewLikeEdge.fromJson(Map<String, dynamic> json) =>
      EdgeMediaPreviewLikeEdge(
